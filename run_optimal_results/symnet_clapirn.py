...
hyperpredict_df= pd.read_csv("../results/symnet_clapirn/data_size/mean_encoding_0.5%_data_values_images.csv")
...
for i in range(len(hyperpredict_df)):
    ...
    print(i)
hyperpredict_df.to_csv("../results/symnet_clapirn/data_size/mean_encoding_0.5%_data_values_images_target_values.csv")
